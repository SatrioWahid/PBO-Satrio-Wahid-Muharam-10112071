...
class komputer {
    ...
    // Diubah menjadi protected agar bisa diakses oleh class laptop
    ...
    // Diubah menjadi protected agar bisa dipanggil di class laptop
    protected function tampilkan_ram() {
        return $this->jenis_RAM;
    }

    // Tetap protected karena dipanggil via method public di class anak
...
class laptop extends komputer {
    ...
    public function display_ram2() {
        return $this->tampilkan_ram(); // Sekarang bisa karena method di ortu sudah protected
    }
    ...
    // Diubah menjadi public agar bisa dipanggil dari objek $laptop di luar class
